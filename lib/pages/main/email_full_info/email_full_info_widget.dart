...
import 'email_full_info_model.dart';
export 'email_full_info_model.dart';

class EmailFullInfoWidget extends StatefulWidget {
  const EmailFullInfoWidget({super.key});

  @override
  State<EmailFullInfoWidget> createState() => _EmailFullInfoWidgetState();
}

class _EmailFullInfoWidgetState extends State<EmailFullInfoWidget> {
  late EmailFullInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmailFullInfoModel());
