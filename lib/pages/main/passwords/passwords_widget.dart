...
import '/components/password_generator_popup/password_generator_popup_widget.dart';
import '/components/password_popup/password_popup_widget.dart';
          ...
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        'Below are the passwords you have saved',
                        style:
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<PasswordsRecord>>(
                        stream: queryPasswordsRecord(
                          ...
                          queryBuilder: (passwordsRecord) => passwordsRecord
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    16.0, 8.0, 16.0, 0.0),
                                child: StreamBuilder<PasswordsRecord>(
                                  stream: PasswordsRecord.getDocument(
                                      listViewPasswordsRecord.reference),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                                                ...
                                                child: SizedBox(
                                                  height:
                                                      MediaQuery.sizeOf(context)
                                                              .height *
                                                          0.9,
                                                  child: const PasswordPopupWidget(),
                                                ),
                                              ),
                                            );
                                          },
                                            ...
                                            children: [
                                              Hero(
                                                tag: valueOrDefault<String>(
                                                  containerPasswordsRecord
                                                      .siteLogo,
                                                  'https://static-00.iconduck.com/assets.00/no-image-icon-2048x2048-2t5cx953.png' '$listViewIndex',
                                                ),
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Username: ${containerPasswordsRecord.username}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
                                                        ...
                                                        padding:
                                                            const EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Last Used: ${dateTimeFormat("yMd", containerPasswordsRecord.lastUsed)}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .labelSmall
                                                              .override(
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  _model.initalPassword = await PasswordGeneratorCall.call(
                    length: 16,
                  );

                  await showModalBottomSheet(
                    isScrollControlled: true,
                    backgroundColor: const Color(0x72000000),
                    enableDrag: false,
                    context: context,
                    builder: (context) {
                      return GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: PasswordGeneratorPopupWidget(
                              initialPassword: getJsonField(
                                (_model.initalPassword?.jsonBody ?? ''),
                                r'''$.password''',
                              ).toString(),
                            ),
                          ),
